...
ifeq ($(OS),Windows_NT)
	...
	CC_POSTFLAGS=-L "C:\Program Files\maple_devtools-win\OpenSSL\lib" -Wl,-Bstatic -lssl -lcrypto -Wl,-Bdynamic -lcrypt32 -lgdi32 -lws2_32 -Wl,--gc-sections
	...
	ifeq ($(UNAME_S),Linux)
		...
		CC_POSTFLAGS=-L "usr/lib/openssl" -Wl,-Bstatic -lssl -lcrypto -Wl,-Bdynamic -lpthread -ldl -Wl,--gc-sections
