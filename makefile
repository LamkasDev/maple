...
ifeq ($(OS),Windows_NT)
	...
	CC_POSTFLAGS= -Wl,--gc-sections -L "C:\Program Files\maple_devtools-win\OpenSSL\lib" -Wl,-Bstatic -lssl -lcrypto -Wl,-Bdynamic -lcrypt32 -lgdi32 -lws2_32
	...
	ifeq ($(UNAME_S),Linux)
		...
		CC_POSTFLAGS= -Wl,--gc-sections -static-libgcc -static-libstdc++ -L "usr/lib/openssl" -Wl,-Bstatic -lssl -lcrypto -Wl,-Bdynamic -lpthread -ldl
